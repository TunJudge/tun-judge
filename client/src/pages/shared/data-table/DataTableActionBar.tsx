  ...
  return (
    <div className="flex items-center shadow rounded-md border w-full justify-between px-4 py-2 bg-white">
      ...
      <div className="flex items-center space-x-2">
        {onRefresh && (
          <div className="hover:bg-gray-200 rounded-md p-2 cursor-pointer" onClick={onRefresh}>
            <RefreshIcon className="w-6 h-6" />
          </div>
        )}
        {canAdd && (
          <div className="hover:bg-gray-200 rounded-md p-2 cursor-pointer" onClick={onAdd}>
