...
export function useCreateManyUser(
  options?: Omit<
    UseMutationOptions<Prisma.BatchPayload, DefaultError, Prisma.UserCreateManyArgs> &
      ExtraMutationOptions,
    'mutationFn'
  >,
) {
  ...
  const _mutation = useModelMutation<
    ...
    Prisma.BatchPayload,
    false
  >('User', 'POST', `${endpoint}/user/createMany`, metadata, options, fetch, false);
  const mutation = {
    ..._mutation,
...
export function useUpdateManyUser(
  options?: Omit<
    UseMutationOptions<Prisma.BatchPayload, DefaultError, Prisma.UserUpdateManyArgs> &
      ExtraMutationOptions,
    'mutationFn'
  >,
) {
  ...
  const _mutation = useModelMutation<
    ...
    Prisma.BatchPayload,
    false
  >('User', 'PUT', `${endpoint}/user/updateMany`, metadata, options, fetch, false);
  const mutation = {
    ..._mutation,
...
export function useDeleteManyUser(
  options?: Omit<
    UseMutationOptions<Prisma.BatchPayload, DefaultError, Prisma.UserDeleteManyArgs> &
      ExtraMutationOptions,
    'mutationFn'
  >,
) {
  ...
  const _mutation = useModelMutation<
    ...
    Prisma.BatchPayload,
    false
  >('User', 'DELETE', `${endpoint}/user/deleteMany`, metadata, options, fetch, false);
  const mutation = {
    ..._mutation,
